...
class FixturesMiddleWare {
    static validateAddFixtures(req, res, next) {
...
_a = FixturesMiddleWare;
FixturesMiddleWare.validateParams = (schema) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.default = FixturesMiddleWare;
